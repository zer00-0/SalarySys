...
void CSelectView::OnInitialUpdate()
{
	...
	m_treeCtrl->InsertItem(TEXT("员工信息管理"), 0, 0, NULL);
	m_treeCtrl->InsertItem(TEXT("信息查询"), 0, 0, NULL);
	m_treeCtrl->InsertItem(TEXT("关于我们"), 0, 0, NULL);
...
void CSelectView::OnTvnSelchanged(NMHDR *pNMHDR, LRESULT *pResult)
{
	...
	*pResult = 0;
	...
	else if (str == TEXT("员工信息管理"))
	{
		if (now_account == "Admin")
			::PostMessage(AfxGetMainWnd()->GetSafeHwnd(), NM_B, (WPARAM)NM_B, (LPARAM)0);
		else
			AfxMessageBox(_T("无访问权限！"));
	}
	else if (str == TEXT("关于我们"))
	{
		::PostMessage(AfxGetMainWnd()->GetSafeHwnd(), NM_C, (WPARAM)NM_C, (LPARAM)0);
	}
	else if (str == TEXT("信息查询"))
	{
